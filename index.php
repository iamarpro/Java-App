<?php
  ...
  define('APP_ID', '926482321034641');
  define('APP_SECRET', 'bafb3f62bc3732d153376fb3046ead34');
...
<html>
  ...
  */
  ...
  if(isset($sess)){
    ...
    $request  = new FacebookRequest($sess, 'GET', '/me?fields=email,gender,birthday,name,first_name,last_name');
  ...
  ?>  
    <div class='user'>
      <div class='wrapper'>
        <table class="tg">
          <tr>
          <th class="tg-031e" rowspan="7"><img src='<?php echo $img;?>' /></th>
          <th class="tg-031e" ><?php  ?></th>
          <th class="tg-031e"><?php  echo $name; ?></th>
          </tr>
          <tr>
          <td class="tg-031e">First name</td>
          <td class="tg-031e"><?php echo $first_name; ?></td>
          </tr>
          <tr>
          <td class="tg-031e">Last name</td>
          <td class="tg-031e"><?php echo $last_name; ?></td>
          </tr>
          <tr>
